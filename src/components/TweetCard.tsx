    ...
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md max-w-md mx-auto">
      <div className="flex items-center mb-4">
        ...
        <div className="flex flex-col justify-center min-h-[3rem]">
            <span className="font-bold leading-tight text-gray-900 dark:text-white">{author}</span>
          <span className="leading-tight text-gray-500 dark:text-gray-400">@{handle}</span>
        </div>
      </div>
